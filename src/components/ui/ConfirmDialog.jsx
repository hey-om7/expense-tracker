    ...
    <Modal isOpen={isOpen} onClose={onCancel} title={title}>
      <div className="flex flex-col gap-6 pt-2 pb-4 px-2">
        ...
        <div className="flex gap-3 mt-2">
          ...
          <button onClick={onConfirm} className="flex-1 bg-error-container text-on-error-container py-3 rounded-xl font-manrope font-bold shadow-xl shadow-error-container/10 hover:brightness-110 transition-all active:scale-95">
            Delete Record
          </button>
        </div>
      </div>
