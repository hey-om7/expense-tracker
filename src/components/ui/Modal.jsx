...
const Modal = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center md:flex md:items-center md:justify-center bg-black/60 backdrop-blur-sm px-4 max-md:items-end max-md:px-0">
      <div className="bg-surface-container-high w-full max-w-md rounded-2xl p-6 shadow-2xl relative max-md:rounded-b-none max-md:rounded-t-2xl max-md:max-h-[92vh] max-md:overflow-y-auto max-md:no-scrollbar max-md:p-5 max-md:pb-8">
